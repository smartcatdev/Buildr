...
<div id="cart-panel">
    ...
    <div id="cart-panel-trigger">
        <span class="fas <?php echo esc_attr( get_theme_mod( 'cart_drawer_tab_icon', 'fa-shopping-cart' ) ); ?>"></span>
    ...
    <div class="inner">
        ...
        <div id="go-to-cart" href="/cart">
            <?php echo esc_html( get_theme_mod( 'slide_cart_heading', __( 'Cart', 'designr' ) ) ); ?>
            <span id="cart-sidebar-quantity">
                <a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'designr' ); ?>">
                    <?php echo esc_html( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'designr' ), WC()->cart->get_cart_contents_count() ) ); ?> 
                    - 
