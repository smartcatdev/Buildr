<section class="sub-section">
    ...
    <img alt="<?php _e( 'Header', 'designr' ); ?>" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/docs/header.jpg' ); ?>">
    ...
    <div class="nested-subsection">
        ...
        <div class="nested-subsection-inner">
            ...
            <p>
                <?php _e( 'You can choose to use this header Parallax Style by selecting it under Header > General Settings. The "Perspective Layers" style is a parallax effect that outputs three layers (your header image, then optional pattern and color overlay layers) that move at different speeds in response to the mouse cursor location.', 'designr' ); ?>
            </p>
            ...
            <ul class="options-list">
                <li><?php _e( 'Transparent Pattern/Texture Image', 'designr' ); ?></li>
                <li><?php _e( 'Transparent Pattern/Texture Opacity', 'designr' ); ?></li>
            </ul>
            <div class="clear"></div>
    ...
    <div class="nested-subsection">
        ...
        <h4>
            <?php _e( 'Header: Overall Settings', 'designr' ); ?>
        </h4>
        
        <div class="nested-subsection-inner">
        
            <p>
                <?php _e( 'The Designr Header features many customizable options, including toggles to determine where the Header is shown and what is displayed within it, and color and gradient settings for the overlay. Some of these settings are only available for certain Parallax Styles, so be sure to look through the options after selecting one to see what is available for you to customize.', 'designr' ); ?>
            </p>
            ...
            <ul class="options-list">
                <li>
                    ...
                    <a href="<?php echo esc_url( $section_link ); ?>">
                        <?php _e( 'Display Locations to set which templates include the Header', 'designr' ); ?>
                    </a>
                </li>
                <li>
                    ...
                    $section_link = add_query_arg( $query, admin_url( 'customize.php' ) ); ?>
                    <a href="<?php echo esc_url( $section_link ); ?>">
                        <?php _e( 'Content settings that determine what is shown in the Header', 'designr' ); ?>
                    </a>
                </li>
            </ul>
            <ul class="options-list">
                <li>
                    ...
                    $section_link = add_query_arg( $query, admin_url( 'customize.php' ) ); ?>
                    <a href="<?php echo esc_url( $section_link ); ?>">
                        <?php _e( 'Header Menu Settings', 'designr' ); ?>
                    </a>
                </li>
                <li>
                    ...
                    $section_link = add_query_arg( $query, admin_url( 'customize.php' ) ); ?>
                    <a href="<?php echo esc_url( $section_link ); ?>">
                        <?php _e( 'Color or Gradient Overlay Settings', 'designr' ); ?>
                    </a>
                </li>
            </ul>
            <div class="clear"></div>
